<div class="panel panel-default">
	<div class="panel-heading">
		...
		<a href="#" class="fa fa-fw fa-filter" onclick="$(searchemployee).modal('show');" data-toggle="tooltip" data-placement="bottom" title="Filter Data"></a>
		<a href="<?php echo base_url().'user/add_employee'; ?>" class="fa fa-fw fa-plus" data-toggle="tooltip" data-placement="bottom" title="ADD Employee"></a>
		<a href="#" class="fa fa-fw fa-edit" id="editemployee" data-toggle="tooltip" data-placement="bottom" title="Edit Employee"></a>
	  	<a href="#"  id="deleteall" class="fa fa-fw fa-trash-o" data-toggle="tooltip" data-placement="bottom" title="Delete employee"></a>
	</div>	
			...
			<div class="box-body table-responsive">
				<table class='table table-bordered table-striped dataTable'>
					...
					<?php
						...
						{
					?>					
						<tr id="etr<?php echo $row['people_id']; ?>">
							<td>
								<label>
							...
							<td><?php if($row['dob']!='') { echo dateformat($row['dob']); } else { echo ""; }?></td>
...
<!-- Modal -->
<div class="modal fade" id="searchemployee" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
...
$(document).ready(function(){
	$('#editemployee').click(function () {
		...
		if(id.length>1 || id.length<1) {
			...
			window.location=base_url+"user/edit_employee/"+id;	
		}
	});
	...
	$('#deleteall').click(function () {
		...
		if(id.length<1) {
			...
			if (x) {
				$.ajax({
					  url     : base_url+"user/del_employee/",
					  type    : 'POST',
					  data    : {'id':id},
