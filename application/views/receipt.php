...
<body>
	<div id="contener" class="">
		...
		<header>
			<img src="<?php echo get_thumb(base_url()."logo/".$invoice[0]['clogo'],'thumb_150'); ?>" alt=""/>
	...
	<input type="button" class="btn btn-primary printNono" data-toggle="tooltip" data-placement="bottom" title="Create PDF" onclick="create_pdf(<?php echo $invoice[0]['inid'];?>);" value="Create PDF">
...
function create_pdf(inid) {
	var base_url = "<?php echo base_url(); ?>";	
	var url=base_url+"invoice/convertpdf/"+inid;
	window.location=url;
}
</script>
